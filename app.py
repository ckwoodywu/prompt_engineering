...
hf_auth = "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"
    ...
    if mode == 'offline' and model == 'llama' and rag == 'on':
        ...
        if use_entire_uploads:
            ...
            if valid_files:
                ...
                # Save uploaded filedresponse': "No valid files uploaded."})
        ...
        bot_response = llamachatbotgpu2(user_input)
